...
export const ProductMaster = IDL.Record({
  'id' : IDL.Nat,
  'voltage' : IDL.Text,
...
export const idlService = IDL.Service({
  ...
  'listProductMaster' : IDL.Func([], [IDL.Vec(ProductMaster)], ['query']),
  'listProductMasterByCategory' : IDL.Func(
      [IDL.Text],
      [IDL.Vec(ProductMaster)],
      ['query'],
    ),
...
export const idlFactory = ({ IDL }) => {
  ...
  const ProductMaster = IDL.Record({
    'id' : IDL.Nat,
    'voltage' : IDL.Text,
    'efficiency' : IDL.Float64,
    'unit' : IDL.Text,
